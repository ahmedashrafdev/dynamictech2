    ...
    public function run()
    {
        $sliders = [
            [
                ...
                "tag_ar" => "#we love development",
                "heading" => "Top business<br> soloutions company",
                "heading_ar" => "Top business<br> soloutions company",
                ...
                "content_ar" => "Since we started in 2008 we have helped multiple customers to realize their<br> business potential and do business in a standard and profitable way. ",
            ...
            [
                ...
                "heading_ar" => "Dynamic technology <br>Gives You Power ",
                "content" => "Dynamic ERP solutions will help you manage your daily processes<br> in the best way",
                "content_ar" => "Dynamic ERP solutions will help you manage your daily processes<br> in the best way",
